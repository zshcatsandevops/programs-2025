...
# -*- coding: utf-8 -*-
"""
Super Mario Bros (NES-Style Emulation) v1.1.1 (Stable Fixed Build)
---------------------------------------------
Procedural NES-style platformer (single-file, no external assets)
Modified to emulate SMB1 main menu screen.
Sprites rendered on the fly like SMB1 NES.
"""
