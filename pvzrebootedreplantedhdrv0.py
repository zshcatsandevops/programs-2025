...
def draw_text(surface, text, pos, color=None, font=None, center=False, shadow=True):
    ...
    if shadow:
        ...
        if center:
            # FIXED: Center shadow at original pos, then offset blit position
...
def draw_peashooter(surface, rect, t):
    ...
    # Happy smile (extra cheerful bounce)
    smile_bounce = 0.2 + 0.1 * math.sin(t * 4)
    pygame.draw.arc(surface, (0, 0, 0), (cx - 10, cy - 8, 20, int(10 * smile_bounce)), smile_bounce, math.pi - smile_bounce, 2)
...
def draw_sunflower(surface, rect, t):
    ...
    pygame.draw.circle(surface, (0, 0, 0), (cx + 6, cy - 4), 3)
    smile_bounce = 0.3 + 0.1 * math.sin(t * 3)  # Extra cheerful
    pygame.draw.arc(surface, (0, 0, 0), (cx - 8, cy - 2, 16, int(12 * smile_bounce)), smile_bounce, math.pi - smile_bounce, 2)
...
def draw_wallnut(surface, rect, t):
    ...
    # Big happy smile (bouncy for top UI cheer)
    smile_bounce = 0.2 + 0.05 * math.sin(t * 5)
    smile_rect = pygame.Rect(cx - 15, cy, 30, int(20 * smile_bounce))
    pygame.draw.arc(surface, (0, 0, 0), smile_rect, smile_bounce, math.pi - smile_bounce, 3)
...
class PlantSelector:
    ...
    def draw(self, surface, game_state, t):
        for i, card in enumerate(self.cards):
            ...
            # Icon (smiling and bouncy for top UI)
